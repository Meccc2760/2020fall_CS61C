...
> **Archived at**: https://web.archive.org/web/20240423100418/https://inst.eecs.berkeley.edu/~cs61c/fa20/labs/lab00/
...
You can view the course policies on the [policies page of the course website](../../policies). You are responsible for understanding and adhering to all policies throughout the course of the semester. Please pay particular attention to the `Grading`, `Labs`, and `Academic Dishonesty and Cheating` sections.
...
Please read through the [Discussion Forum section of our policies](../../policies#discussion-forum). Please remember and follow the Piazza Etiquette!
...
If you have not done so already, please read through the [Labs section of our policies](../../policies#labs).
