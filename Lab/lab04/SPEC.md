...
> **Archived at**: https://web.archive.org/web/20220121174546/https://inst.eecs.berkeley.edu/~cs61c/fa20/labs/lab04/
...
Like last week, we will be using the **Venus RISC-V simulator** (which can be found online [here](https://venus.cs61c.org/)). Also, please refer to the [Venus Guide](../../../sp21/resources/venus-reference) on our course website when you need a refresher on any of the Venus features.
...
4.  Save your corrected code in the `megalistmanips.s` file. **Use the `-cc` flag to run a basic calling convention check on your code locally**:
    ...
    Again, the [Venus Guide](../../../sp21/resources/venus-reference) is a great resource if you feel unsure about any of the Venus features.
