...
> **Archived at**: https://web.archive.org/web/20220121184030/https://inst.eecs.berkeley.edu/~cs61c/fa20/labs/lab03/
...
To get started with Venus, please take a look at “The Editor Tab” and “The Simulator Tab” in the [Venus reference](../../../sp21/resources/venus-reference). We recommend that you read this whole page at some point, but these sections should be enough to get started.
...
You will find it helpful to refer to the [RISC-V green card](../../../sp21/resources-pdfs/riscvcard.pdf) to complete this exercise. If you encounter any instructions or pseudo-instructions you are unfamiliar with, use this as a resource.
...
- [Writing Larger RISC-V Programs](../../../sp21/resources/venus-reference#writing-larger-risc-v-programs)
- [Using the Web Terminal](../../../sp21/resources/venus-reference#the-venus-tab)
- [Passing Command Line Arguments](../../../sp21/resources/venus-reference#the-venus-tab)
